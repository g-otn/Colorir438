...
int main(int argc, char **argv)
{
	...
	do
	{
		...
		printf("\n\t"); c(5); printf("\xC9\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xBB");
		printf("\n\t"); c(5); printf("\xBA  "); c(5); 	printf("          --== "); c(11); printf("Colorir"); c(13); printf("438"); c(5); printf(" ==--           "); c(5); printf("\xBA  ");
		printf("\n\t"); c(5); printf("\xBA  "); c(8); 	                   printf("g-otn (https://github.com/g-otn) - 2019  "); c(5); printf("\xBA  ");
		...
		printf("\n\t"); c(5); printf("\xC8\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xBC\n");
